...
export function useInvoice(tableRef: any) {
  ...
  const handleBatchDestroy = (ids: number[]) => {
    invoiceApi.batchDestroy(ids).then(() => {
      onSearch();
    });
  };
  ...
  function onSearch() {
    ...
    if (params.created_at) {
      params.created_at = convertDateRangeToISO(params.created_at) as any;
    }
