 ...
 * @method string getRecordType() 获取获取某种类型的解析记录
 * @method void setRecordType(string $RecordType) 设置获取某种类型的解析记录
