...
import { useContactSearch } from "./search";
import { useContactStore } from "./store";
import { useContactTable } from "./table";
...
// 创建搜索列配置
const { searchColumns } = useContactSearch(() => onSearch());
