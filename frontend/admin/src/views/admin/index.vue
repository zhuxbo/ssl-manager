...
import { useAdminSearch } from "./search";
import { useAdminStore } from "./store";
import { useAdminTable } from "./table";
...
// 创建搜索列配置
const { searchColumns } = useAdminSearch(() => onSearch());
