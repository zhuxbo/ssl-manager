...
import { useCallback } from "./hook";
import { useCallbackSearch } from "./search";
import { useCallbackStore } from "./store";
import { useCallbackTable } from "./table";
...
const {
  ...
  handleDestroy,
  handleBatchDestroy
} = useCallback(tableRef);

// 创建搜索列配置
const { searchColumns, debouncedSearch } = useCallbackSearch(() => onSearch());
...
<template>
  <div class="main">
    ...
    <PureTableBar title="回调管理" :columns="tableColumns" @refresh="onSearch">
      <template #buttons>
