...
import { useCert } from "./hook";
import { searchColumns } from "./search";
import { useCertTable } from "./table";
...
const tableColumns = useCertTable();
</script>
...
<template>
  <div class="main">
    ...
    <PureTableBar title="证书管理" :columns="tableColumns" @refresh="onSearch">
    ...
    <Detail :id="currentId" v-model="detailVisible" />
  </div>
</template>
