...
import { useApiToken } from "./hook";
import { useApiTokenSearch } from "./search";
import { useApiTokenStore } from "./store";
import { useApiTokenTable } from "./table";
...
const {
  ...
  handleDestroy,
  handleBatchDestroy
} = useApiToken(tableRef);

// 创建搜索列配置
const { searchColumns, debouncedSearch } = useApiTokenSearch(() => onSearch());
