...
import { useChainSearch } from "./search";
import { useChainStore } from "./store";
import { useChainTable } from "./table";
...
// 创建搜索列配置
const { searchColumns } = useChainSearch(() => onSearch());
...
<template>
  <div class="main">
    ...
    <PureTableBar title="证书链" :columns="tableColumns" @refresh="onSearch">
      <template #buttons>
